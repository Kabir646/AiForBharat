                  ...
                  <div className="space-y-6">
                    <div>
                      ...
                      <div className="mb-4">
                        ...
                        <p className="text-muted-foreground">
                          This comprehensive highway development project aims to
                          modernize and expand the transportation infrastructure
                          in the Northeast region. The project includes road
                          widening, bridge construction, and installation of
