        ...
        <div className="max-w-3xl mx-auto text-center space-y-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-xl text-muted-foreground max-w-xl mx-auto">
              Select your role to access the platform and start analyzing
          ...
          <div className="grid md:grid-cols-2 gap-6 pt-8">
            ...
            >
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground">
                  Full access to upload, analyze, and manage DPR documents with
                  AI-powered insights
                </p>
                <div className="pt-4">
            ...
            >
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground">
                  Upload and manage your DPRs, track project progress, and
                  access analyzed reports
                </p>
                <div className="pt-4">
      ...
      <footer className="border-t py-6">
        <div className="container mx-auto px-4 text-center">
          <p className="text-sm text-muted-foreground">
            © 2025{" "}
            <span className="text-primary font-semibold">DPR Analyzer</span> -
            Government of India Infrastructure Platform
          </p>
        </div>
      </footer>
