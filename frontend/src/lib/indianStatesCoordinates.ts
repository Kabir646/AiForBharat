...
export const indianStatesCoordinates: Record<string, StateCoordinates> = {
  // States
  "andhra pradesh": { name: "Andhra Pradesh", lat: 15.9129, lng: 79.74 },
  "arunachal pradesh": { name: "Arunachal Pradesh", lat: 28.218, lng: 94.7278 },
  ...
  meghalaya: { name: "Meghalaya", lat: 25.467, lng: 91.3662 },
  ...
  sikkim: { name: "Sikkim", lat: 27.533, lng: 88.5122 },
  ...
  "west bengal": { name: "West Bengal", lat: 22.9868, lng: 87.855 },
