...
const DPRAnalyzerLanding: React.FC = () => {
  ...
  >([
    {
      role: "bot",
      text: "Hello! I am your AI assistant for MoDoNER DPR analysis. How can I help you today?",
    },
  ]);
  ...
  const handleChatSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setChatHistory((prev) => [
        ...
        {
          role: "bot",
          text: "I'm analyzing that request based on the latest DPR guidelines...",
        },
      ]);
    }, 1000);
    setChatMessage("");
  ...
  return (
    <div
      className={`min-h-screen font-sans transition-colors duration-300 ${isDarkMode ? "bg-slate-900 text-white" : "bg-slate-50 text-slate-900"}`}
    >
      {/* ━━━━━━━━━━━━━━━━━━━━━━━━━━
          1. HEADER
      ━━━━━━━━━━━━━━━━━━━━━━━━━━ */}
      <header
        className={`fixed top-0 w-full z-50 transition-all duration-300 ${isDarkMode ? "bg-slate-900/70 border-b border-slate-800" : "bg-white/60 border-b border-slate-200"} backdrop-blur-md`}
      >
        ...
        {mobileMenuOpen && (
          <div
            className={`md:hidden absolute w-full border-b ${isDarkMode ? "bg-slate-900 border-slate-800" : "bg-white border-slate-200"}`}
          >
            <div className="px-4 pt-2 pb-6 space-y-4">
              <a href="#features" className="block py-2 font-medium">
                Features
              </a>
              <a href="#comparison" className="block py-2 font-medium">
                Compare
              </a>
              <a href="#states" className="block py-2 font-medium">
                States
              </a>
              <div className="flex items-center justify-between pt-4 border-t border-slate-700/30">
                ...
                <button
                  onClick={toggleTheme}
                  className="p-2 bg-slate-200/20 rounded-full"
                >
                  {isDarkMode ? <Sun size={18} /> : <Moon size={18} />}
                </button>
              </div>
              <a
                href={LOGIN_PATH}
                className="block w-full text-center py-3 rounded-lg bg-blue-600 text-white font-bold"
              >
                Login Portal
              </a>
            </div>
      ...
      <main>
        ...
        <section className="relative h-screen min-h-[600px] flex items-center justify-center overflow-hidden">
          ...
          <div className="absolute inset-0 z-0">
            ...
            {/* Gradient Overlay */}
            <div
              className={`absolute inset-0 bg-gradient-to-b ${isDarkMode ? "from-slate-900/80 via-slate-900/40 to-slate-900" : "from-white/50 via-slate-100/30 to-white/60"}`}
            ></div>
            <div
              className={`absolute inset-0 bg-gradient-to-r ${isDarkMode ? "from-blue-900/20 to-indigo-900/20" : "from-blue-900/20 to-indigo-900/20"} mix-blend-overlay`}
            ></div>
          </div>

          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div
              className={`inline-flex items-center space-x-2 px-3 py-1 rounded-full ${isDarkMode ? "bg-blue-500/10 border-blue-500/20 text-blue-400" : "bg-blue-600/15 border-blue-600/30 text-blue-700"} border text-xs font-medium mb-6 animate-fade-in-up`}
            >
              <span className="relative flex h-2 w-2">
                <span
                  className={`animate-ping absolute inline-flex h-full w-full rounded-full ${isDarkMode ? "bg-blue-400" : "bg-blue-600"} opacity-75`}
                ></span>
                <span
                  className={`relative inline-flex rounded-full h-2 w-2 ${isDarkMode ? "bg-blue-500" : "bg-blue-600"}`}
                ></span>
              </span>
            ...
            <h1
              className={`text-5xl md:text-7xl font-extrabold tracking-tight mb-6 bg-clip-text text-transparent drop-shadow-lg ${isDarkMode ? "bg-gradient-to-r from-blue-500 via-green-400 to-purple-600" : "bg-gradient-to-r from-indigo-600 via-violet-600 to-blue-500"}`}
            >
              DPR Analyzer
            </h1>

            <p className="text-xl md:text-2xl max-w-3xl mx-auto mb-10 font-medium text-white">
              AI-powered DPR analysis for the North Eastern States.{" "}
            ...
            <div className="grid grid-cols-3 gap-8 max-w-2xl mx-auto mb-12">
              <div className="text-center">
                ...
                <div className="text-xs uppercase tracking-wider text-white opacity-80">
                  PDFs Processed
                </div>
              </div>
              <div className="text-center">
              ...
              <div className="text-center">
                <div
                  className={`text-3xl font-bold ${isDarkMode ? "text-indigo-400" : "text-indigo-700"}`}
                >
                  {STATES_COVERED}
                </div>
                <div className="text-xs uppercase tracking-wider text-white opacity-80">
            ...
            <p
              className={`mt-8 text-sm ${isDarkMode ? "text-white opacity-60" : "text-black opacity-80"}`}
            >
              Built for MoDoNER — Government of India
            </p>
          </div>
        </section>
        ...
        <section
          id="features"
          className={`py-24 ${isDarkMode ? "bg-slate-900" : "bg-slate-50"}`}
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p
                className={`font-semibold max-w-2xl mx-auto ${isDarkMode ? "text-white" : "text-black"}`}
              >
        ...
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div
                className={`p-8 rounded-3xl border ${isDarkMode ? "bg-slate-900 border-slate-700" : "bg-slate-50 border-slate-200"} shadow-2xl`}
              >
                <div className="flex items-center justify-between mb-6">
                  <h3 className="text-xl font-bold flex items-center gap-2">
                    <Layers size={20} className="text-indigo-500" /> DPR
                    Comparison
                  </h3>
                  <span className="text-xs px-2 py-1 rounded bg-indigo-500/10 text-indigo-500">
                    Live Demo
                  </span>
                </div>
              ...
              {/* Map Preview Card */}
              <div
                className={`p-8 rounded-3xl border ${isDarkMode ? "bg-slate-900 border-slate-700" : "bg-slate-50 border-slate-200"} shadow-2xl relative overflow-hidden group`}
              >
                ...
                <div
                  className={`absolute inset-0 bg-gradient-to-t ${isDarkMode ? "from-slate-900 via-slate-900/50" : "from-white via-white/50"} to-transparent`}
                ></div>

                <div className="relative z-10">
                  <h3 className="text-xl font-bold flex items-center gap-2 mb-2">
                    <MapIcon size={20} className="text-blue-500" /> Geospatial
                    Intelligence
                  </h3>
                  <p className="text-sm opacity-70 mb-6">
                    Visualize project distribution and regional impact.
                  </p>
                ...
                {/* Mock Marker Popup */}
                <div
                  className={`absolute bottom-8 right-8 p-4 rounded-xl ${isDarkMode ? "bg-slate-800/90" : "bg-white/90"} backdrop-blur-md shadow-lg border border-slate-500/20 max-w-[200px] transform translate-y-2 group-hover:translate-y-0 transition-transform`}
                >
                  <div className="text-xs font-bold mb-1">
                    Assam Highway Project
                  </div>
            ...
            <div className="flex justify-between items-end mb-12">
              <div>
                <h2 className="text-3xl font-bold mb-2">
                  Serving the North Eastern States
                </h2>
                <p className="opacity-60">
                  Empowering development across the North East.
                </p>
              </div>
              <div className="hidden md:flex gap-2">
                <button className="p-2 rounded-full border border-slate-500/30 hover:bg-slate-500/10">
                  ...
                  <div key={idx} className="min-w-[25%] px-2">
                    <div className="group relative aspect-[2/3] rounded-xl overflow-hidden cursor-pointer">
                      <img
                        ...
                        decoding="async"
                        onError={(e) =>
                          (e.currentTarget.src = `https://source.unsplash.com/random/300x400?nature,mountain&sig=${idx}`)
                        }
                      />
      ...
      ━━━━━━━━━━━━━━━━━━━━━━━━━━ */}
      <footer
        className={`py-16 border-t ${isDarkMode ? "bg-slate-950 border-slate-800" : "bg-slate-100 border-slate-200"}`}
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-16 pt-8 border-t border-slate-500/10 text-center text-xs opacity-40">
            ...
            Eastern Region. All rights reserved.
          </div>
        </div>
      </footer>
      ...
      {/* Chat Panel */}
      <div
        className={`fixed top-0 right-0 h-full w-full sm:w-96 z-30 transform transition-transform duration-300 ease-in-out ${isChatOpen ? "translate-x-0" : "translate-x-full"} ${isDarkMode ? "bg-slate-900 border-l border-slate-800" : "bg-white border-l border-slate-200"} shadow-2xl`}
      >
        <div className="flex flex-col h-full">
          <div
            className={`p-4 border-b ${isDarkMode ? "border-slate-800" : "border-slate-100"} flex justify-between items-center`}
          >
            <h3 className="font-bold flex items-center gap-2">
              <MessageSquare size={18} className="text-blue-500" /> AI Assistant
            </h3>
            <button className="text-xs px-2 py-1 rounded bg-slate-500/10 hover:bg-slate-500/20">
              English / Hindi
            </button>
          </div>
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-4">
            {chatHistory.map((msg, i) => (
              ...
              >
                <div
                  className={`max-w-[80%] p-3 rounded-2xl text-sm ${msg.role === "user" ? "bg-blue-600 text-white rounded-tr-none" : "bg-slate-200/20 rounded-tl-none"}`}
                >
                  {msg.text}
                </div>
              </div>
          ...
          >
            <div className="relative">
              ...
              <button
                type="submit"
                className="absolute right-2 top-2 p-1.5 rounded-lg bg-blue-500 text-white hover:bg-blue-600 transition-colors"
              >
                <Send size={16} />
              </button>
            </div>
